...
function loadConfigFile(filePath) {
    ...
    } else if (filePath.indexOf("plugin:") === 0) {
        config = loadPluginConfig(filePath.substr(7, filePath.length - 7));
    } else {
...
function resolve(filePath) {
    ...
    if (isFilePath(filePath)) {
        ...
        // it's a package
        return filePath.indexOf("plugin:") === 0 ? "plugin:" + normalizePackageName(filePath.split(":")[1], "eslint-plugin") : normalizePackageName(filePath, "eslint-config");
    }
}
