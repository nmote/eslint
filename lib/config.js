...
Config.prototype.getConfigForDirectory = function(filePath) {
    ...
    // Step 2: add baseDirectory to each glob based configuration
    if (userConfig.files) {
        userConfig.files.forEach(function(globConfiguration) {
            globConfiguration.baseDirectory = directory;
        });
    }

    // Step 3: Create a copy of the baseConfig
...
Config.prototype.getConfigForFile = function(filePath, directoryConfig) {
    ...
    if (globConfigurations) {
        ...
        globConfigurations.forEach(function(globConfiguration) {
            if (pathIsInside(filePath, globConfiguration.baseDirectory)) {
